...
import { DEFAULT_SORT_TYPE, DEFAULT_COMMENT_SORT_TYPE } from "@/constants/settings";
...
export default function BookmarkPage({
  ...
  return (
    <>
    <div className="flex w-full min-h-screen flex-col items-center overflow-x-hidden ">
        ...
        <div className="flex w-full flex-col items-center gap-4 bg-neutral-50 dark:bg-neutral-950 dark:pt-4">
            ...
            <div className={` w-full  dark:text-neutral-300`}>
                <div className="flex w-full max-w-2xl flex-row items-center justify-between">
                    <div className="relative flex flex-row flex-wrap w-full items-center gap-4">
            ...
            <div className="flex min-h-screen flex-col items-center justify-start w-full overflow-hidden" style={{ maxWidth: "42rem" }}>
                ...
                >
                    {filter == "Posts" && posts.map((post: PostView, index: number) => {
                        return (
                        <Post
                            post={post}
                            key={post.post.id}
                    ...
                    {filter == "Comments" && comments.map((comment: CommentView, index: number) => {
                        return (
