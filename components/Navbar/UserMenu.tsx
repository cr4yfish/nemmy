      ...
      >
        <div className={`flex h-full w-full flex-col gap-4`}>
          ...
          <div className={`${styles.userMenuInteractionsTop}`}>
            <Link onClick={() => handleClose()} href={"/inbox"}>
              <button className="relative">
                <div className="relative flex h-full w-fit items-center justify-center">
                  {unreadCount > 0 && (
                    <span
                      className=" absolute left-1/3 top-0 m-2
                                        rounded-full bg-red-400 px-1 text-xs font-bold text-red-950
                                        "
                    >
                      {unreadCount}
                    </span>
            ...
            <Link
              onClick={() => handleClose()}
              href={`/u/${session.currentAccount?.user?.person?.name}@${session.currentAccount?.instance}`}
            >
              <button>
                <span className="material-symbols-outlined">
                  account_circle
            ...
            <Link onClick={() => handleClose()} href="/post/new">
              <button>
                <span className="material-symbols-outlined">
                  add_circle_outline
                </span>
            ...
            <Link onClick={() => handleClose()} href={"/c/new"}>
              <button>
        ...
        <div className={`${styles.userMenuInteractionsBottom}`}>
          ...
          <Link onClick={() => handleClose()} href={"/settings"}>
            <button>
