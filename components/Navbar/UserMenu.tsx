...
function UserMenuItem({ text, icon, link, close, disabled } : { text: string, icon: string, link: string, close: Function, disabled?: boolean }) {
  if (disabled) {
    return (
      <>
...
export default function UserMenu({
  ...
  >
    <div className={`flex h-full w-full flex-col gap-4`}>
      ...
      <span><Link href={"/auth"} className="a">Log in</Link> for more features.</span>
      }
